<template>
  <nav class="pt-4">
    ...
    <h4 class="text-xs uppercase text-gray-500 font-bold pt-12">Create</h4>
    <router-link
      exact
      active-class="active"
      to="/contacts/create"
    ...
    >
      <svg viewBox="0 0 24 24" class="fill-current text-blue-600 w-4 h-4">
        <path
      ...
      <div class="tracking-wide pl-3 font-semibold">Add New</div>
    </router-link>

    <h4 class="text-xs uppercase text-gray-500 font-bold pt-12">General</h4>
    ...
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
        class="fill-current text-blue-600 w-4 h-4"
      >
        <path
          class="st0"
      ...
      <div class="tracking-wide pl-3 font-semibold">Contacts</div>
    </router-link>
    ...
    >
      ...
      <div class="tracking-wide pl-3 font-semibold">Birthdays</div>
    </router-link>

      <router-link :to="{}"></router-link>

    <h4 class="text-xs uppercase text-gray-500 font-bold pt-12">Settings</h4>
    ...
    >
      ...
      <div class="tracking-wide pl-3 font-semibold">Logout</div>
    </router-link>
  </nav>
</template>
